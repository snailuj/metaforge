...
_Append-only. Never edit or remove existing rows. To reverse a decision, add a new row that supersedes it. Read this file at the start of any planning or research phase._

_Migrated from `.gsd/DECISIONS.md` on 2026-05-03 during GSD decommission._
